...
import com.vigoss.wechat.base.http.support.apache3.HttpComponent3.SSLProtocolSocketFactory;
...
public class HttpComponent3Factory extends HttpClientFactory {
    ...
    @Override
    public com.vigoss.wechat.base.http.HttpClient newInstance(HttpParams params) {
