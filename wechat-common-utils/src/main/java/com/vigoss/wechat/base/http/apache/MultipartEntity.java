...
package com.vigoss.wechat.base.http.apache;
...
public class MultipartEntity implements HttpEntity {
	...
	public MultipartEntity(HttpMultipartMode mode, String boundary,
		...
		this.multipart = new HttpMultipart("form-data", charset, this.boundary, mode);
		this.dirty = true;
	}
	...
	public ContentType getContentType() {
		return ContentType.create(MimeType.MULTIPART_FORM_DATA.toString(),this.boundary);
	}
