...
var vm = new Vue({
    ...
    methods: {
        ...
        getRole: function (roleId) {
            $.get(uris.sysrole_info_query + roleId, function (r) {
                vm.role = r.data;
        ...
        saveOrUpdate: function (event) {
            ...
            var url = vm.role.roleId == null ? uris.sysrole_save : uris.sysrole_update;
            $.ajax({
                type: "POST",
                url: url,
                contentType: "application/json",
        ...
        getMenuTree: function (roleId) {
            //加载菜单树
            $.get(uris.sysmenu_perms, function (r) {
        ...
        getDataTree: function (roleId) {
            //加载菜单树
            $.get(uris.sysdept_list, function (r) {
