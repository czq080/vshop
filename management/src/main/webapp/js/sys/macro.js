...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, uris.sysmacro_queryAll, colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getMacros: function () {
            $.get(uris.sysmacro_queryAll + "?type=0", function (r) {
                vm.macros = r.data;
            });
        },
        add: function () {
        ...
        update: function (event) {
            ...
            vm.showList = false;
            vm.title = "修改";
            $.get(uris.sysmacro_info_query + id[0].id, function (r) {
                vm.macro = r.data;
            });
            vm.getMacros();
        },
        saveOrUpdate: function (event) {
            var url = vm.macro.id == null ? uris.sysmacro_save : uris.sysmacro_update;
            $.ajax({
                type: "POST",
                url: url,
