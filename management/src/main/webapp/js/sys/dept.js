...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, uris.sysdept_list, colunms);
...
var vm = new Vue({
    ...
    methods: {
        getDept: function () {
            //加载部门树
            $.get(uris.sysdept_select, function (r) {
        ...
        update: function () {
            ...
            $.get(uris.sysdept_info_query + deptId, function (r) {
                vm.showList = false;
                vm.title = "修改";
                vm.dept = r.data;
        ...
        saveOrUpdate: function (event) {
            var url = vm.dept.deptId == null ? uris.sysdept_save : uris.sysdept_update;
            $.ajax({
                type: "POST",
                url: url,
