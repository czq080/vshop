...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, uris.sysmenu_queryAll, colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getMenu: function (menuId) {
            //加载菜单树
            $.get(uris.sysmenu_select, function (r) {
        ...
        update: function (event) {
            ...
            $.get(uris.sysmenu_info_query + menuId[0].id, function (r) {
                vm.showList = false;
                vm.title = "修改";
                vm.menu = r.data;
        ...
        saveOrUpdate: function (event) {
            var url = vm.menu.menuId == null ? uris.sysmenu_save : uris.sysmenu_update;
            $.ajax({
                type: "POST",
                url: url,
                contentType: "application/json",
