...
var vm = new Vue({
    ...
    methods: {
        ...
        update: function () {
            ...
            $.get(uris.sysuser_info_query + userId, function (r) {
                vm.user = r.user;
                //获取角色信息
                vm.getRoleList();
                vm.getDept();
        ...
        saveOrUpdate: function (event) {
            var url = vm.user.userId == null ? uris.sysuser_save : uris.sysuser_update;
            $.ajax({
                type: "POST",
                url: url,
                contentType: "application/json",
